...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, l as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, m as Certificate, n as lookupResultToBuffer, p as RequestStatusResponseStatus, U as UnknownError, q as RequestStatusDoneNoReplyErrorCode, s as RejectError, t as CertifiedRejectErrorCode, v as UNREACHABLE_ERROR, I as InputError, w as InvalidReadStateRequestErrorCode, x as ReadRequestType, y as Principal, z as IDL, A as MissingCanisterIdErrorCode, H as HttpAgent, D as encode, Q as QueryResponseStatus, F as UncertifiedRejectErrorCode, G as isV3ResponseBody, J as isV2ResponseBody, K as UncertifiedRejectUpdateErrorCode, N as UnexpectedErrorCode, O as decode, V as Subscribable, W as pendingThenable, X as resolveEnabled, Y as shallowEqualObjects, Z as resolveStaleTime, _ as noop, $ as environmentManager, a0 as isValidTimeout, a1 as timeUntilStale, a2 as timeoutManager, a3 as focusManager, a4 as fetchState, a5 as replaceData, a6 as notifyManager, a7 as hashKey, a8 as getDefaultState, r as reactExports, a9 as shouldThrowError, aa as useQueryClient, ab as useInternetIdentity, ac as createActorWithConfig, c as createLucideIcon, j as jsxRuntimeExports, ad as Slot, a as cn, ae as cva, af as Variant, ag as Record, ah as Vec, ai as Service, aj as Func, ak as Text, al as Opt, am as Principal$1, an as Nat, ao as Null, ap as Int, aq as Nat8, ar as Bool } from "./index-iS1Ggpz8.js";
...
const CodeSnippet = Record({
  "code": Text,
  "filename": Text
});
const GenerationResult = Record({
  "overview": Overview,
...
const GenerationSummary = Record({
  "id": GenerationId,
  "createdAt": Timestamp,
  "promptPreview": Text
});
...
Service({
  ...
  "deleteGeneration": Func(
    [GenerationId],
    [Variant({ "ok": Null, "err": Text })],
    []
  ),
  "generateApp": Func([Text], [GenerationResult], []),
  "getCallerUserProfile": Func([], [Opt(UserProfile)], ["query"]),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getGeneration": Func([GenerationId], [Opt(Generation)], ["query"]),
  "getMyGenerations": Func([], [Vec(GenerationSummary)], ["query"]),
  "getUserProfile": Func(
    [Principal$1],
    [Opt(UserProfile)],
    ["query"]
  ...
  "saveGeneration": Func(
    [Text, Overview, Architecture, Vec(CodeSnippet)],
    [Variant({ "ok": GenerationId, "err": Text })],
    []
  ),
  "transform": Func(
    [TransformationInput],
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const GenerationId2 = IDL2.Nat;
  const Overview2 = IDL2.Record({
    "concept": IDL2.Text,
    "targetUsers": IDL2.Text,
    "keyFeatures": IDL2.Vec(IDL2.Text)
  });
  const Architecture2 = IDL2.Record({
    "systemDesign": IDL2.Text,
    "dataFlow": IDL2.Text,
    "techStack": IDL2.Vec(IDL2.Text)
  });
  const CodeSnippet2 = IDL2.Record({ "code": IDL2.Text, "filename": IDL2.Text });
  const GenerationResult2 = IDL2.Record({
    "overview": Overview2,
    "architecture": Architecture2,
    "codeSnippets": IDL2.Vec(CodeSnippet2)
  });
  const UserProfile2 = IDL2.Record({ "name": IDL2.Text });
  const UserId2 = IDL2.Principal;
  const Timestamp2 = IDL2.Int;
  const Generation2 = IDL2.Record({
    "id": GenerationId2,
    "userId": UserId2,
  ...
  const GenerationSummary2 = IDL2.Record({
    "id": GenerationId2,
    "createdAt": Timestamp2,
    "promptPreview": IDL2.Text
  });
  ...
  return IDL2.Service({
    ...
    "deleteGeneration": IDL2.Func(
      [GenerationId2],
      [IDL2.Variant({ "ok": IDL2.Null, "err": IDL2.Text })],
      []
    ),
    "generateApp": IDL2.Func([IDL2.Text], [GenerationResult2], []),
    "getCallerUserProfile": IDL2.Func([], [IDL2.Opt(UserProfile2)], ["query"]),
    "getCallerUserRole": IDL2.Func([], [UserRole2], ["query"]),
    "getGeneration": IDL2.Func(
      [GenerationId2],
      [IDL2.Opt(Generation2)],
      ["query"]
    ),
    "getMyGenerations": IDL2.Func([], [IDL2.Vec(GenerationSummary2)], ["query"]),
    ...
    "saveGeneration": IDL2.Func(
      [IDL2.Text, Overview2, Architecture2, IDL2.Vec(CodeSnippet2)],
      [IDL2.Variant({ "ok": GenerationId2, "err": IDL2.Text })],
      []
    ),
    "transform": IDL2.Func(
...
class Backend {
  ...
  async saveGeneration(arg0, arg1, arg2, arg3) {
    if (this.processError) {
      try {
...
function useGeneration(id) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["generation", id == null ? void 0 : id.toString()],
    queryFn: async () => {
...
export {
  ...
  LoaderCircle as L,
  Plus as P,
  useSaveGeneration as a,
  useGeneration as b,
  useMyGenerations as c,
  useDeleteGeneration as d,
  useGenerateApp as u
};
