import { c as createLucideIcon, j as jsxRuntimeExports, a as cn, o, r as reactExports, R as ReactDOM, u as useAuth, b as useSearch, B as Button, S as Skeleton } from "./index-iS1Ggpz8.js";
import { u as useGenerateApp, a as useSaveGeneration, b as useGeneration, L as LoaderCircle, P as Plus, B as Badge } from "./useBackend-Dazs4t_L.js";
...
const TABS = [
  ...
  },
  {
    id: "code",
    label: "Code Preview",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CodeXml, { className: "w-3.5 h-3.5" })
  }
];
function ResultSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 p-6", "data-ocid": "result-skeleton", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-3/4" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-full" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-5/6" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-4 w-2/3" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "pt-4 space-y-2", children: [
...
function OverviewTab({ overview }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-6", "data-ocid": "tab-overview", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-mono uppercase tracking-widest text-muted-foreground mb-2", children: "Concept" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground leading-relaxed font-body", children: overview.concept })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-mono uppercase tracking-widest text-muted-foreground mb-2", children: "Target Users" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground font-body", children: overview.targetUsers })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-mono uppercase tracking-widest text-muted-foreground mb-3", children: "Key Features" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: overview.keyFeatures.map((feat) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-2.5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 text-accent shrink-0 mt-0.5" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-body text-sm", children: feat })
      ] }, feat)) })
    ] })
  ] });
}
function ArchitectureTab({ arch }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-6 space-y-6", "data-ocid": "tab-architecture", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-mono uppercase tracking-widest text-muted-foreground mb-2", children: "System Design" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground leading-relaxed font-body", children: arch.systemDesign })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-mono uppercase tracking-widest text-muted-foreground mb-3", children: "Tech Stack" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: arch.techStack.map((tech) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Badge,
        {
          variant: "secondary",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-mono uppercase tracking-widest text-muted-foreground mb-2", children: "Data Flow" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground leading-relaxed font-body", children: arch.dataFlow })
    ] })
  ] });
}
function CodePreviewTab({
  ...
  function copyCode(filename, code) {
    navigator.clipboard.writeText(code).then(() => {
      setCopied(filename);
      setTimeout(() => setCopied(null), 2e3);
    });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "divide-y divide-border", "data-ocid": "tab-code", children: snippets.map((snippet) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-2 bg-muted/60 border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs text-foreground tracking-tight", children: snippet.filename }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          children: copied === snippet.filename ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-3.5 h-3.5 text-accent" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: "Copied!" })
          ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Copy, { className: "w-3.5 h-3.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: "Copy" })
          ] })
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "overflow-x-auto p-4 text-xs font-mono leading-relaxed bg-foreground/[0.06] text-foreground dark:bg-muted dark:text-accent", children: /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: snippet.code }) })
  ] }, snippet.filename)) });
}
function DeploymentInstructions() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-5 py-3 bg-muted/40 border-b border-border flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs font-semibold uppercase tracking-widest text-muted-foreground", children: "Deployment Instructions" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ol", { className: "divide-y divide-border", children: DEPLOY_STEPS.map(({ step, title, cmd }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-4 px-5 py-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-shrink-0 w-6 h-6 rounded-full bg-accent text-accent-foreground flex items-center justify-center font-mono text-xs font-bold", children: step }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body font-medium text-sm text-foreground mb-1", children: title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("code", { className: "font-mono text-xs text-muted-foreground bg-muted/60 px-2 py-1 rounded break-all block", children: cmd })
          ] })
        ] }, step)) })
      ]
    }
...
function Builder() {
  ...
  const { data: savedGeneration, isLoading: isLoadingSaved } = useGeneration(viewId);
  ...
  async function handleSave() {
    ...
    if (res.__kind__ === "ok") {
      setSaved(true);
      ue.success("Generation saved to My Apps!");
    } else {
      ue.error(`Save failed: ${res.err}`);
    }
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 py-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-black text-3xl tracking-tight text-foreground mb-1", children: "AI App Builder" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-body text-sm", children: "Describe your app and let AI generate the full-stack architecture, code, and deployment plan." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-[1fr_1.1fr] gap-8 items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-5", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border rounded-lg bg-card overflow-hidden shadow-sm", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 border-b border-border bg-muted/30 flex items-center gap-2", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono text-xs font-semibold uppercase tracking-widest text-muted-foreground", children: "App Description" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mt-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-mono text-muted-foreground", children: charCount < 10 ? `${10 - charCount} more chars needed` : `${charCount} / 1000` }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  className: `text-xs font-mono ${charCount > 900 ? "text-destructive" : "text-muted-foreground"}`,
                  children: charCount > 0 && `${1e3 - charCount} left`
                }
              )
            ] })
          ] })
        ...
        hasError && !isLoading && /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-sm font-medium text-foreground mb-1", children: "Generation failed" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-body text-xs text-muted-foreground line-clamp-2", children: ((_a = generateApp.error) == null ? void 0 : _a.message) ?? "An unexpected error occurred. Please try again." })
              ] }),
        ...
        result && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              variant: "outline",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              "data-ocid": "save-btn",
              children: [
                saveGeneration.isPending ? /* @__PURE__ */ jsxRuntimeExports.jsx(LoaderCircle, { className: "w-4 h-4 mr-2 animate-spin" }) : saved ? /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "w-4 h-4 mr-2 text-accent" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(Save, { className: "w-4 h-4 mr-2" }),
                saved ? "Saved!" : isAuthenticated ? "Save to My Apps" : "Login to Save"
              ]
            }
          )
        ] })
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border border-border rounded-lg bg-card overflow-hidden shadow-sm", children: [
            ...
            children: TABS.map((tab) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  className: `flex-1 flex items-center justify-center gap-1.5 px-3 py-3 font-mono text-xs font-semibold uppercase tracking-widest transition-colors duration-200 focus-visible:outline-none focus-visible:ring-inset focus-visible:ring-1 focus-visible:ring-ring ${isActive ? "bg-accent text-accent-foreground border-b-2 border-accent" : "text-muted-foreground hover:text-foreground hover:bg-muted/40"}`,
                  children: [
                    tab.icon,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(ResultSkeleton, {}) : result ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
              activeTab === "overview" && /* @__PURE__ */ jsxRuntimeExports.jsx(OverviewTab, { overview: result.overview }),
              activeTab === "architecture" && /* @__PURE__ */ jsxRuntimeExports.jsx(ArchitectureTab, { arch: result.architecture }),
              activeTab === "code" && /* @__PURE__ */ jsxRuntimeExports.jsx(CodePreviewTab, { snippets: result.codeSnippets })
            ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-14 h-14 rounded-full bg-muted/60 border border-border flex items-center justify-center mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Sparkles, { className: "w-6 h-6 text-muted-foreground" }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-lg text-foreground mb-2", children: "Your results will appear here" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "font-body text-sm text-muted-foreground max-w-xs", children: [
                    "Describe your app and click",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold", children: "Generate App" }),
                    " to get the AI-powered overview, architecture, and code."
                  ] })
                ]
              }
            )
    ...
    result && /* @__PURE__ */ jsxRuntimeExports.jsx(DeploymentInstructions, {})
  ] });
}
export {
  Builder as default
